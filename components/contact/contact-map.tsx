	...
	return (
		<section className="w-full relative px-4 md:px-0 pb-12">
			<div className="container mx-auto">
				...
				>
					<div className="absolute -inset-1 bg-gradient-to-r from-primary-900 to-primary-600 rounded-3xl blur opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200"></div>
							...
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<a
										...
										className="text-sm text-primary-900 font-semibold mt-2 inline-block hover:underline underline-offset-2"
									>
										Get Directions →
									</a>
								</div>
