			...
			<div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 px-4 md:px-0 border-b border-dashed border-gray-300 pb-6">
				<div className="flex-1">
					...
					{department.description && (
						<p className="text-gray-500 max-w-2xl text-base leading-relaxed mt-3 font-medium">
							{department.description}
						</p>
					)}
				</div>
				<div className="flex items-center text-sm font-bold text-gray-500 uppercase tracking-widest shrink-0">
