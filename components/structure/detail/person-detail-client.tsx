...
export function PersonDetailClient({ person }: PersonDetailClientProps) {
	...
	/* ---------------------------------------------------------------- */
	/*  PDF Generation – optimised for professional CV output           */
	/* ---------------------------------------------------------------- */
	...
	/* ---------------------------------------------------------------- */
	/*  Data helpers — null-safe extraction                             */
	/* ---------------------------------------------------------------- */
	const experiences =
	...
	/* ================================================================ */
	return (
		<div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100/50 print:bg-white">
			{/* --- Top hero area --- */}
			<section className="relative pt-24 lg:pt-28 pb-12 md:pb-16 bg-gradient-to-br from-khmer-gold/5 via-white to-khmer-gold/3 print:pt-4 print:pb-4 print:bg-white">
				...
				<div className="absolute top-0 right-0 w-72 h-72 bg-khmer-gold/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 pointer-events-none print:hidden" />
				<div className="absolute bottom-0 left-0 w-56 h-56 bg-khmer-gold/5 rounded-full blur-3xl translate-y-1/3 -translate-x-1/4 pointer-events-none print:hidden" />
										...
										{[...experiences]
											...
											.map((exp, index) => {
												...
												const desc =
													...
													exp.description?.km ||
													"";
												const years = `${exp.startYear || "—"} – ${exp.endYear || "Present"}`;
							...
							{!hasAnySections && (
								<div className="flex flex-col items-center justify-center py-16 text-center print:py-8">
									...
									<p className="text-sm text-gray-400 max-w-sm">
										This member&apos;s detailed profile
